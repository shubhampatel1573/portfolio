  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className="fixed top-0 left-0 w-full z-[90] px-8 md:px-12 py-5 flex justify-between items-center backdrop-blur-xl bg-[#0a0a0a]/80 border-b border-white/[0.06]"
      >
        <button 
          onClick={() => {
            if (isTransitioning) return;
        ...
        <div className="flex gap-10 text-sm font-['Inter'] font-medium">
